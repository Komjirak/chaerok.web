 ...
 *
 * 제목을 "두 번째 뇌니까, 생각은 내 기기 안에"로 바꿨다 — 예전 제목
 * ("오늘의 통찰이 내일의 지혜가…")은 프라이버시와 무관했고, 세컨 브레인
 * 컨셉을 그대로 신뢰의 근거로 잇는다(일기 은유는 쓰지 않는다 — 채록은
 * 일기 앱이 아니다). "여러 기기에서 이어보기"는 모든 입구 절로 옮기고,
 * 그 자리에 "볼모 없는 구독"(해지해도 기록은 내 폰에)을 넣었다.
 */
      ...
      <div className="max-w-[1200px] mx-auto px-5 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-lg text-ink-muted leading-relaxed mb-12 text-balance">
              {t('privacy.desc')}
            </p>
